            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavId">
                    <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                        <li class="nav-item">
                            <a class="nav-link roboto-semibold" href="#" aria-current="page">Trang chủ
                                <span class="visually-hidden">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link roboto-semibold" href="#">Đăng bài</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link roboto-semibold" href="#">Danh sách bài đăng</a>
                        </li>
